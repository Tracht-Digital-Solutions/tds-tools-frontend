import { ct as defineMiddleware, t as sequence } from "./chunks/sequence_D8AML-3n.mjs";
import { a as ensureCatalogSynced } from "./chunks/connection_jGVRvpuo.mjs";
import { t as siteCache } from "./chunks/pageCache_BMhcPgnM.mjs";
import { r as siteKeyRejectionCount } from "./chunks/siteKey_qLmc5xZf.mjs";
...
var retryCatalogSync = defineMiddleware((_context, next) => {
	ensureCatalogSynced().catch((error) => {
...
*/
var onRequest$1 = sequence(retryCatalogSync, defineMiddleware((context, next) => siteCache.middleware({
