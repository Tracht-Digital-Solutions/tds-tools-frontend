...
import { c as softwareApplicationSchema, d as $$AdSlot, f as $$Icon, i as howToSchema, m as runtimeSetting, n as breadcrumbSchema, p as $$Layout, r as faqPageSchema, t as asGraph, u as $$ServiceNote } from "./jsonld_CZXTFNiU.mjs";
import { r as contentCache } from "./cache_Co9YbPGn.mjs";
import { t as apiBase } from "./connection_Cd_viREH.mjs";
import { n as siteKeyHeaders, t as assertKeyAccepted } from "./siteKey_B9-8uOOv.mjs";
import { d as t, f as toolCopyFor, l as site, n as enabledTools, r as localizedPath, t as adsConfig } from "./catalog_B2y3Hjla.mjs";
...
function LabelSheet({ lang = "de" }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			error && /* @__PURE__ */ jsx("p", {
				className: "tds-alert tds-alert--danger tds-appear",
				role: "alert",
				children: error
			}),
			status && /* @__PURE__ */ jsx("p", {
				className: "tds-alert tds-alert--success tds-appear",
				children: status
			}),
			/* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			result && /* @__PURE__ */ jsxs("div", {
				className: "tds-card tds-appear space-y-3 p-4",
				children: [
					/* @__PURE__ */ jsx("p", {
						className: "text-xs opacity-60",
						children: t.result
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			text !== "" && /* @__PURE__ */ jsxs("div", {
				className: "space-y-3 tds-appear",
				children: [/* @__PURE__ */ jsxs("label", {
					className: "block text-sm",
					children: [/* @__PURE__ */ jsx("span", {
						className: "mb-1 block opacity-80",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			result?.ok && result.output !== void 0 && /* @__PURE__ */ jsxs("div", {
				className: "space-y-2 tds-appear",
				children: [/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			pages.length > 0 && /* @__PURE__ */ jsxs("div", {
				className: "space-y-4 tds-appear",
				children: [/* @__PURE__ */ jsx("button", {
					type: "button",
					className: "btn btn-ghost",
...
var $$ToolPage = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {
		...
		"jsonLd": jsonLd
	}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<div class="tds-page tds-shell py-10"><nav class="text-sm text-[color:var(--color-muted)]"><a${addAttribute(`${base}/`, "href")} class="tnav-link link-underline">${s.breadcrumbAll}</a><span class="mx-2">/</span><span class="text-[color:var(--color-ink)]">${copy.name}</span></nav><div class="tool-intro"><div class="tds-page__head"><h1 class="tds-page__title tool-title flex w-full items-center gap-3">${renderComponent($$result, "Icon", $$Icon, {
		"name": tool.icon,
		"class": "h-7 w-7 shrink-0 text-[color:var(--color-accent)]"
	})}<span class="min-w-0 hyphens-auto break-words">${copy.name}</span></h1></div><p class="tds-page__lede max-w-2xl">${copy.description}</p></div><div class="tool-layout"><div class="tool-main">${gated && renderTemplate`${renderComponent($$result, "ToolGate", ToolGate, {
		"client:load": true,
		"toolId": tool.id,
		...
		"toolName": copy.name,
		"lang": lang
	})}`}</div><div class="tool-aside">${guide && renderTemplate`${renderComponent($$result, "RelatedTools", $$RelatedTools, {
		"slugs": guide.related,
		"all": allTools,
		"current": tool.slug,
		"lang": lang,
		"base": base
	})}`}${renderComponent($$result, "ServiceNote", $$ServiceNote, { "lang": lang })}</div></div></div>` })}`;
