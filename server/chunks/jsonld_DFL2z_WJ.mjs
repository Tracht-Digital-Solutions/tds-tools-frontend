import { A as renderTemplate, At as number, D as renderSlot, Dt as _enum, F as createRenderInstruction, M as renderHead, Mt as string, N as addAttribute, Ot as array, P as defineScriptVars, T as Fragment$2, V as createAstro, j as maybeRenderHead, jt as object, kt as boolean, w as renderComponent, z as unescapeHTML } from "./sequence_Y1dSITeG.mjs";
import { t as createComponent } from "./compiler_Cpo7oIUD.mjs";
...
var themeBootstrapScript = `(function () {
  function apply(root) {
    try {
      var saved = localStorage.getItem("${THEME_STORAGE_KEY$1}");
      if (saved === "light" || saved === "dark") {
        root.setAttribute("${THEME_ATTRIBUTE$1}", saved);
        return;
      }
    } catch (e) { /* storage disabled \u2014 fall through to OS */ }
    var dark = window.matchMedia &&
      window.matchMedia("(prefers-color-scheme: dark)").matches;
    root.setAttribute("${THEME_ATTRIBUTE$1}", dark ? "dark" : "light");
  }
...
//#endregion
export { itemListSchema as a, softwareApplicationSchema as c, $$AdSlot as d, $$Icon as f, howToSchema as i, websiteSchema as l, renderScript as m, breadcrumbSchema as n, organizationSchema as o, $$Layout as p, faqPageSchema as r, personSchema as s, asGraph as t, $$ServiceNote as u };
