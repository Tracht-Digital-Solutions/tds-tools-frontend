...
import { L as unescapeHTML, O as renderTemplate, gt as joinPaths, ht as isRemotePath, j as addAttribute, k as maybeRenderHead, mt as isParentDirectory, y as spreadAttributes, yt as removeQueryString, z as createAstro } from "./sequence_D8AML-3n.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_D4sRUBW-.mjs").catch((e) => {
