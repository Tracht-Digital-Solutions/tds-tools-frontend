import{t as e}from"./react.ClNNcLFM.js";var t=e(),n=e=>(e??``).trim(),r=(e,t=`, `)=>e.map(n).filter(Boolean).join(t);function i(e,t){let r=[n(e)];for(let e of t){let t=e.paragraphs.map(n).filter(Boolean);r.push([n(e.heading),...t].join(`
